// ════════════════════════════════════════════════════════════════════
//  EasyAzureIoT.cpp — Implementación
// ════════════════════════════════════════════════════════════════════
#include "EasyAzureIoT.h"
#include <azure_ca.h>

// ── Constructor ──────────────────────────────────────────────────────
EasyAzureIoT::EasyAzureIoT(
...
// ════════════════════════════════════════════════════════════════════
void EasyAzureIoT::begin()
{
  Serial.println();
  Serial.println("╔══════════════════════════════════╗");
  Serial.println("║       EasyAzureIoT v1.0          ║");
  Serial.println("╚══════════════════════════════════╝");
...
// ════════════════════════════════════════════════════════════════════
void EasyAzureIoT::publish(Payload payload)
{
...
// ════════════════════════════════════════════════════════════════════
void EasyAzureIoT::publish(JsonDocument &doc)
{
...
// ════════════════════════════════════════════════════════════════════
void EasyAzureIoT::publishRaw(const String &json)
{
...
//  connected() / timestamp()
// ════════════════════════════════════════════════════════════════════
bool EasyAzureIoT::connected()
{
  return _mqtt_client.connected();
}

String EasyAzureIoT::timestamp()
{
  struct tm t;
  if (!getLocalTime(&t))
...
void EasyAzureIoT::_log(const char *section)
{
  Serial.print(">>> ");
...
// ── WiFi ─────────────────────────────────────────────────────────────
void EasyAzureIoT::_connectWifi()
{
  _log("WiFi");
  WiFi.mode(WIFI_STA);
...
void EasyAzureIoT::_initAzureClient()
{
...
void EasyAzureIoT::_generateSasToken()
{
  _log("SAS Token");
...
// ── Conectar MQTT ─────────────────────────────────────────────────────
void EasyAzureIoT::_connectMqtt()
{
  _log("MQTT");
...
void EasyAzureIoT::_checkTokenRenewal()
{
...
void EasyAzureIoT::_sendPayload(const char *json)
{
  if (!_mqtt_client.connected())
  {
